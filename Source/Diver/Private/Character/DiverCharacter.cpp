...
ADiverCharacter::ADiverCharacter()
{
	...
	DiverActions = CreateDefaultSubobject<UDiverActions>(TEXT("DiverActionsComponent"));
	...
	FollowCamera->SetRelativeLocation(FVector(0.f, 0.f, 130.0f));
...
void ADiverCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
...
void ADiverCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
